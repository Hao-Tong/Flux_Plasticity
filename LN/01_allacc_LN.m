...
addpath('/winmounts/tong/winhome/mpidir/8.AlleleFlux/00_GxE/LN');
cd /winmounts/tong/winhome/mpidir/8.AlleleFlux/00_GxE/LN/cvx/
cvx_setup

cd /winmounts/tong/winhome/mpidir/8.AlleleFlux/00_GxE/LN
...
biofunc = csvread('biofunallaccfinal_LN.csv',0,0);
fluxall = [];
optvalall = [];
...
csvwrite('AraCore_allacc_LN.csv',fluxall);

save('AraCore_allacc_LN.mat','fluxall');
