...
# Output: flux prediction using rrBLUP
write.table(ypredall,paste("fluxpredict_",r,".csv",sep=""),sep=",",row.names=F,col.names=F)

# Output: flux prediction accuracy
write.table(corallall,"fluxpredict_cor.csv",sep=",",row.names=F,col.names=F)
